      ...
      <div className="w-full max-w-md bg-zinc-900/80 backdrop-blur-md border border-white/10 p-8 rounded-2xl shadow-2xl relative z-10">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="name" type="text" placeholder="Seu nome" className="bg-zinc-800/50 border-zinc-700 text-white placeholder:text-zinc-500" required />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="password" type="password" placeholder="Mínimo 8 caracteres" className="bg-zinc-800/50 border-zinc-700 text-white" required />
          </div>
